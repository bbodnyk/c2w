...
// Camera 5 Setup
//
#declare CAMERA5_LOCATION = <30,6,10>;     // <13,4,6>
#declare CAMERA5_LOOKAT =  <6,9.5,10>;      // <3,2,0>
...
//
#declare USERSIDEWALLCOLOR = <227/255,39/255,140/255>;
#declare USERCEILINGCOLOR = <66/255,239/255,242/255>;
#declare USERFRONTCOLOR = <255/255,144/255,1/255>;
#declare USERCURTAINCOLOR = <248/255,231/255,184/255>;
...
#declare BACKLIGHTS = 1;        // 0 (off) or 1 (on) - Can be turned off if doing closeups of front 
#declare AREA_LITES = 1;        // 0 (off) or 1 (on) - Replaces area_lights with point light sources for test purposes.
...
//                                       
#declare ALTERSTUFF = 1;        // 0 (off) or 1 (on) - Alter, pulpit, lecturn, etc.
#declare HANGINGLAMP = 1;       // 0 (off) or 1 (on) - Eternal Light
#declare PEWS = 1;              // 0 (off) or 1 (on) - Congregation Pews
#declare PEWS_CHOIR = 1;        // 0 (off) or 1 (on) - Choir Pews
#declare RAILINGS = 1;          // 0 (off) or 1 (on) - Railings, front, organ, choir
#declare HYMNALS = 1;           // 0 (off) or 1 (on) - Hynals, Bibles & pencils in pews
#declare LIGHTFIXTURES = 1;     // 0 (off) or 1 (on) - Side wall Sconces
#declare CHANDELIER = 1;        // 0 (off) or 1 (on) - Chandeliers (Need to be on for ceiling lights)
#declare JESUS = 1;             // 0 (off) or 1 (on) - Picture of Jesus
#declare SCREEN_OPEN = 1.0;     // range 0 (up) to 1 (down)
#declare VIDEO_ON = 1;          // 0 (off) or 1 (on) - Video Image On
...
#declare VIDEO_IMAGE = "youthgroup.jpg";
//#declare VIDEO_IMAGE = "umc_colored.jpg";
#declare VIDEO_EMISSION = 0.8;  // range 0.0-1.0     - brightness of video image
#declare WINDOWS = 1;           // 0 (off) or 1 (on) - Windows
#declare MURAL = 0;             // 0 (off) or 1 (on) - Front Mural
#else
//
//
...
#declare BACKLIGHTS = 1;        // 0 (off) or 1 (on) Can be turned off if doing closeups of front
#declare TREE_EMISSION = 1.0;   // 0.0-1.0 Brilliance of outside trees
#declare FLAME_EMISSION = 1.0;  // 0.0-1.0 Candle flame brilliance
#declare AREA_LITES = 1;        // 0 (off) or 1 (on)
#declare LITE_JITTER = 1;
//                       
